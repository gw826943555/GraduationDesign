...
int main(void)
{
  uint8_t CRCBuffer[] = "STM32F334xx CortexM4 Device running on STM32F3348-DISCO";
  uint8_t ComputedCRC = 0;
  uint8_t ExpectedCRC = 0xCA; /* The expected CRC value of CRCBuffer using the
  ...
  /* Initialize LEDs available on STM32F3348-DISCO board */
