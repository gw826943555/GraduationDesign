...
@par Directory contents 
  ...
  - TIM_TimeBase/stm32f3xx_it.c       Interrupt handlers
  - TIM_TimeBase/stm32f3xx_it.h       Header for stm32f3xx_it.c
...
@par Hardware and Software environment
 ...
 - This example runs on STM32F334xx Devices.
  ...
  - STM32F3348-DISCO Set-up
    - Use LED3, LED4, LED5 and LED6 connected respectively to PB.06, PB.08,PB.09 
      and PB.07 pins and connect them on an oscilloscope to show the different 
      Time Base signals.
