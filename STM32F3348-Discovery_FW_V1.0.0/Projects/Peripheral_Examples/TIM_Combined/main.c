...
static void TIM_Config(void)
{
  ...
  uint32_t Channel1Pulse = 0, Channel2Pulse = 0, Channel3Pulse = 0, Channel5Pulse = 0;
  ...
  /* Channel 1, 2,3 and 5 Configuration in PWM mode */
