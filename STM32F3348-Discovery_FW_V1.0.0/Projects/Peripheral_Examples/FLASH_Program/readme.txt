...
If MemoryProgramStatus is equal to PASSED then flash program test is OK and LED5
is On. Otherwise, the flash program test is failed and LED3 is On.
 
@par Directory contents 

  - FLASH_Program/stm32f30x_conf.h     Library Configuration file
  - FLASH_Program/stm32f3xx_it.c       Interrupt handlers
  - FLASH_Program/stm32f3xx_it.h       Header for stm32f3xx_it.c
